...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/BH-Skins/main/MX-LiveFHD-posterX-v3_mod-HAhmed.tar.gz"
wait
tar -xzf MX-LiveFHD-posterX-v3_mod-HAhmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/MX-LiveFHD-posterX-v3_mod-HAhmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
